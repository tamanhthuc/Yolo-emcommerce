const product_01_image_01 =
  require("../../images/home/product-childs/product-accssorys/product-01.jpg").default;
const product_02_image_01 =
  require("../../images/home/product-childs/product-accssorys/product-02.jpg").default;

const accessoryChildProducts = [
  {
...
const getAllProducts = () => accessoryChildProducts;

const getProducts = (count) => {
  const max = accessoryChildProducts.length - count;
  const min = 0;
  const start = Math.floor(Math.random() * (max - min) + min);

  return accessoryChildProducts.slice(start, start + count);
};

const getProductBySlug = (slug) =>
  accessoryChildProducts.find((e) => e.slug === slug);
